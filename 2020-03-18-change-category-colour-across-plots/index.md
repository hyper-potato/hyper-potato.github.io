...
Self-quarantine gets me nerd-out on small things that I usally googled again and again.
...
We can use a **list** of colors or a **dictionary** to mao colors onto categories. I will be using dictionary in the following example.

The example is to plot new york housing price and rental price across boroughs.
